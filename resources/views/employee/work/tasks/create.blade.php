@extends('omis.partials.layouts')
            ...
            <div class="container">
                ...
                <div class="nk-block-head-between flex-wrap gap g-2">
                    <div class="nk-block-head-content">
                        <h2 class="nk-block-title">Add Tasks</h1>
 ...
 @csrf 
<div class="row"><div class="col-lg-6">{{createDate("tasksStartDate","tasksStartDate","TasksStartDate")}}
</div><div class="col-lg-6">{{createDate("tasksEndDate","tasksEndDate","TasksEndDate")}}
...
</div><div class="col-lg-4">{{createText("companyName","companyName","CompanyName")}}
...
<!-- <div class="col-lg-6">{{createText("updateBy","updateBy","UpdateBy")}}
</div> -->
 <br> <div class="col-md-12"><?php createButton("btn-primary","","Submit"); ?>
