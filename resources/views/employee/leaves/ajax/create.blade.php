...
</div><div class="col-lg-4">{{createText("leaveApprovalBy","leaveApprovalBy","Leave Approval By")}}
</div><div class="col-lg-4">{{createDate("leaveApprovedDate","leaveApprovedDate","Leave Approved Date")}}
