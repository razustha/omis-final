          ...
          <div class="col-xxl-12">
            <div class="nk-block-head-between flex-wrap gap g-3">
              ...
              <div class="d-flex flex-column flex-sm-row-reverse align-items-sm-center justify-content-sm-between">
                <div class="mb-0 mt-4 mt-sm-0"> @if(empty(auth()->user()->todayAttendance())) <button class="btn btn-primary btn-checkIn"> + Clock In </button> @else <form action="{{route('hr.attendence.checkOut',auth()->user()->todayAttendance()->attendence_id)}}" method="POST"> @csrf <div class="form-group ">
                      <input type="hidden" value="{{auth()->user()->id}}">
                      <button type="submit" class="btn btn-danger btn-checkOut"> - Clock Out </button>
                    </div>
                  </form> @endif </div>
                <div class="p-2">
                    <div class="container">
                    ...
                    <div class="nk-block-head-content">
                      <div class="d-flex flex-column flex-md-row align-items-md-center">
                        <div class="media media-huge media-circle">
                          <img src="{{ auth()->user()->employee->profilePhoto }}" class="img-thumbnail">
                        </div>
                        <div div class="mt-3 mt-md-0 ms-md-3">
                          <h3 class="title mb-1">{{ auth()->user()->name }}</h3>
              ...
              <div class="card-body py-2 flex-grow-0">
                <div class="card-title-group">
                  ...
                  <div class="card-tools d-none d-sm-inline-block">
                    <a href="#" class="btn btn-sm btn-soft btn-primary">Export Report</a>
                  </div>
                </div>
              </div>
                    ...
                    <tr>
                      ...
                      <th class="tb-col tb-col-end">
                        <span class="overline-title">
                          <span class="d-none d-sm-inline-blcok">due</span> date </span>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td class="tb-col">
                        <div class="media-group">
                          <div class="media-text">
                            <a href="#" class="title">Create Wireframe</a>
                      ...
                      <td class="tb-col tb-col-end">
                        <span class="badge text-bg-info-soft">In progress</span>
                      </td>
                      <td class="tb-col tb-col-end">
