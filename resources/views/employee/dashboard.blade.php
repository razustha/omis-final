                                        ...
                                        <div class="row g-gs">
                                                ...
                                                <div class="card h-100">
                                                    <div class="card-body">
                                                        <div
                                                            ...
                                                            <div class="nk-chart-project-active js-pureknob"
                                                                data-readonly="true" data-size="110"
                                                                data-angle-offset="0.4" data-angle-start="1"
                                                                data-angle-end="1" data-value="73"
                                                                data-track-width="0.15"></div>
                                                            <div class="card-title mb-0 mt-4 mt-sm-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="change up"><em
                                                                            class="icon ni ni-upword-alt-fill"></em>
                                                                        +2.7%</div><span class="text-light"> Projects
                                                                        this month</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card h-100">
                                                    <div class="card-body">
                                                        <div
                                                            class="d-flex flex-column flex-sm-row-reverse align-items-sm-center justify-content-sm-between gx-xl-5">
                                                            <div class="nk-chart-project-earnings"><canvas
                                                                    data-nk-chart="bar" id="earningsChart"></canvas>
                                                            </div>
                                                            <div class="card-title mb-0 mt-4 mt-sm-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="change up"><em
                                                                            class="icon ni ni-upword-alt-fill"></em>
                                                                        10.5%</div><span class="text-light">From last
                                                                        Week</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="card h-100">
                                                    <div class="card-body">
                                                        <div
                                                            ...
                                                            <div class="nk-chart-project-earnings"><canvas
                                                                    data-nk-chart="line"
                                                                    id="totalClientsChart"></canvas></div>
                                                            <div class="card-title mb-0 mt-4 mt-sm-0">
                                                                ...
                                                                <div
                                                                    class="d-flex align-items-center smaller flex-wrap">
                                                                    <div class="change up"><em
                                                                            class="icon ni ni-upword-alt-fill"></em> 2%
                                                                    </div><span class="text-light">Than last
                                                                        month</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card h-100">
                                                    <div class="card-body">
                                                        <div
                                                            class="d-flex flex-column flex-sm-row-reverse align-items-sm-center justify-content-sm-between gx-xl-5">
                                                            <div class="nk-chart-project-done js-pureknob"
                                                                data-readonly="true" data-size="136"
                                                                data-angle-offset="-.5" data-angle-start=".7"
                                                                data-angle-end=".7" data-value="65"
                                                                data-color-fg="#F24A8B" data-track-width="0.15"><span
                                                                    class="knob-title small text-light">Task Done</span>
                                                            </div>
                                                            <div class="card-title mb-0 mt-4 mt-sm-0">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="change up"><em
                                                                            class="icon ni ni-upword-alt-fill"></em>
                                                                        14.2%</div><span class="text-light">From last
                                                                        week</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="card-body d-flex flex-column justify-content-between">
                                                <div class="row g-gs text-center">
                                                    <div class="col-6 col-sm-3">
                                                        <div class="amount h2 mb-0 text-success">946</div><span
                                                            class="smaller">Total Projects</span>
                                                    </div>
                                                    <div class="col-6 col-sm-3">
                                                        <div class="amount h2 mb-0 text-primary">280</div><span
                                                            class="smaller">Active Projects</span>
                                                    </div>
                                                    <div class="col-6 col-sm-3">
                                                        <div class="amount h2 mb-0 text-secondary">586</div><span
                                                            class="smaller">Revenue</span>
                                                    </div>
                                                    <div class="col-6 col-sm-3">
                                                        <div class="amount h2 mb-0 text-warning">9,453</div><span
                                                            class="smaller">Working Hours</span>
                                                    </div>
                                                </div>
                                                <div class="nk-chart-project-overview mt-3"><canvas
                                                        data-nk-chart="bar" id="projectsOverviewChart"></canvas></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xxl-7">
                                                ...
                                                <table class="table table-middle mb-0">
                                                    <thead class="table-light table-head-sm">
                                                        <tr>
                                                            <th class="tb-col"><span
                                                                    class="overline-title">items</span></th>
                                                            <th class="tb-col tb-col-end tb-col-xxl"><span
                                                                    class="overline-title">budget</span></th>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="tb-col tb-col-end tb-col-xxl"><span
                                                                    class="small">$32,400</span></td>
                                                            ...
                                                            <td class="tb-col tb-col-end  tb-col-xxl">
                                                                <div class="media-group media-group-overlap">
                                                                    <div class="media media-xs media-circle media-border border-white"
                                                                        ...
                                                                        data-bs-placement="top" title="David"><img
                                                                            src="images/avatar/a.jpg" alt="">
                                                                    </div>
                                                                    <div class="media media-xs media-circle media-border border-white"
                                                                        data-bs-toggle="tooltip"
                                                                        data-bs-placement="top" title="Sanjoy"><img
                                                                            src="images/avatar/b.jpg" alt="">
                                                                    </div>
                                                                    <div class="media media-xs media-circle media-border border-white"
                                                                        data-bs-toggle="tooltip"
                                                                        data-bs-placement="top" title="Kinchit"><img
                                                                            src="images/avatar/c.jpg" alt="">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="tb-col tb-col-end"><span class="small">07 Sep
                                                                    2022</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="tb-col">
                                                            ...
                                                            <td class="tb-col tb-col-end tb-col-xxl">
                                                                <div class="media-group media-group-overlap">
                                                                    <div class="media media-xs media-circle media-border border-white"
                                                                        data-bs-toggle="tooltip"
                                                                        data-bs-placement="top" title="Alex Smith">
                                                            ...
                                                            <td class="tb-col tb-col-end"><span class="small">12 Aug
                                                                    2022</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="tb-col">
                                                            ...
                                                            <td class="tb-col tb-col-end"><span class="small">18 Oct
                                                                    2022</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="tb-col">
                                                            ...
                                                            <td class="tb-col tb-col-end tb-col-xxl">
                                                                <div class="media-group media-group-overlap">
                                                                    <div class="media media-xs media-circle media-border border-white"
                                                                        data-bs-toggle="tooltip"
                                                                        data-bs-placement="top" title="Jhon"><img
                                                                            src="images/avatar/a.jpg" alt="">
                                                                    </div>
                                                                    <div class="media media-xs media-circle media-border border-white"
                                                                        data-bs-toggle="tooltip"
                                                                        data-bs-placement="top" title="Marku"><img
                                                                            src="images/avatar/b.jpg" alt="">
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="tb-col tb-col-end"><span class="small">25 Jul
                                                                    2022</span></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="tb-col">
                                                            ...
                                                            <td class="tb-col tb-col-end tb-col-xxl">
                                                                <div class="media-group media-group-overlap">
                                                                    <div class="media media-xs media-circle media-border border-white"
                                                                        data-bs-toggle="tooltip"
                                                                        data-bs-placement="top" title="Kevin"><img
                                                                            src="images/avatar/a.jpg" alt="">
                                                                    </div>
                                                                    <div class="media media-xs media-circle media-border border-white"
                                                                        data-bs-toggle="tooltip"
                                                                        data-bs-placement="top" title="Ebadot"><img
                                                                            src="images/avatar/b.jpg" alt="">
                                                                    </div>
                                                                    <div class="media media-xs media-circle media-border border-white"
                                                                        data-bs-toggle="tooltip"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="tb-col tb-col-end tb-col-xxl">
                                                                <div class="media-group media-group-overlap">
                                                                    <div class="media media-xs media-circle media-border border-white"
                                                                        data-bs-toggle="tooltip"
                                                                        data-bs-placement="top" title="Jane Smith">
                                                                        <img src="images/avatar/a.jpg" alt="">
                                                                    </div>
                                                                    <div class="media media-xs media-circle media-border border-white"
                                                                        data-bs-toggle="tooltip"
                                                ...
                                                <div class="row g-gs">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="media-group my-4">
                                                            ...
                                                            <div class="media-text"><span class="title">Jenny
                                                                    Wilson</span><span
                                                                    class="text smaller">Manager</span></div>
                                                        </div>
                                                        <p class="small">Flat cartoony illustrations with vivid
                                                            unblended colors and asymmetrical beautiful purple hair lady
                                                        </p>
                                                        <div class="list-group-dotted mt-4 mb-5">
                                                            <div class="list-group-wrap">
                                                                <div class="p-3">
                                                                    <div class="h5 mb-0">25 Oct 2022</div><span
                                                                        class="smaller">Due Date</span>
                                                                </div>
                                                                <div class="p-3">
                                                                    <div class="h5 mb-0">$58,642</div><span
                                                                        class="smaller">Budget</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex flex-wrap gap g-3">
                                                            <div class="gap-col"><a href="#"
                                                                    class="btn btn-sm btn-soft btn-primary"><span>View
                                                                        Project</span><em
                                                                        class="icon ni ni-external-alt"></em></a></div>
                                                            <div class="gap-col">
                                                                <div class="media-group media-group-overlap"><a
                                                                        href="#"
                                                                        class="media media-sm media-circle media-border border-white"
                                                                        data-bs-toggle="tooltip"
                                                                        ...
                                                                        data-bs-toggle="tooltip"
                                                                        data-bs-placement="top"
                                                                        title="Kevin Martin"><img
                                                                            src="images/avatar/b.jpg"
                                                                            alt=""></a></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6 text-sm-end"><img
                                                            src="images/product/a-lg.jpg" alt=""
                                                            class="rounded img-cover"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="amount-wrap mt-3 mb-4">
                                                    ...
                                                    <div class="d-flex align-items-center smaller">
                                                        <div class="change up"><em class="icon ni ni-trend-up"></em>
                                                            +2%</div><span>than last Week</span>
                                                    </div>
                                                </div>
                                                <div class="list-group-dotted">
                                                    <div class="list-group-wrap flex-column">
                                                        <div class="py-1 px-2">
                                                            <div class="d-flex flex-wrap justify-content-between"><span
                                                                    class="small">2:30 PM</span><span
                                                                    class="small">$5,256.26</span><span
                                                                    class="change down small">-129.34</span></div>
                                                        </div>
                                                        <div class="py-1 px-2">
                                                            <div class="d-flex flex-wrap justify-content-between"><span
                                                                    class="small">3:55 PM</span><span
                                                                    class="small">$5,837.34</span><span
                                                                    class="change up small">+539.84</span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="nk-chart-project-avg-earnings mt-4"><canvas
                                                        data-nk-chart="line" id="avgEarningsChart"></canvas></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-xxl-4">
                                                ...
                                                <ul class="nk-schedule mt-4">
                                                    ...
                                                    <li class="nk-schedule-item">
                                                        <div class="nk-schedule-item-inner">
                                                            <div class="nk-schedule-symbol"></div>
                                                            <div class="nk-schedule-content"><span
                                                                    class="smaller">18:00</span>
                                                                <div class="h6 mb-0">Break through self doubt and fear
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </li>
                                        ...
                                        <div class="card h-100">
                                            <div class="card-body py-2 flex-grow-0">
                                                <div class="card-title-group">
                                                    ...
                                                    <div class="card-tools d-none d-sm-inline-block"><a href="#"
                                                            class="btn btn-sm btn-soft btn-secondary"><span>Add
                                                                Member</span></a></div>
                                                </div>
                                            </div>
                                            <div class="table-responsive">
                                                <table class="table table-middle mb-0">
                                                    <thead class="table-light table-head-sm">
                                                        <tr>
                                                            <th class="tb-col"><span
                                                                    class="overline-title">members</span></th>
                                                            <th class="tb-col tb-col-end"><span
                                                                    class="overline-title">tasks</span></th>
                                                            <th class="tb-col tb-col-end tb-col-sm"><span
                                                                    class="overline-title">status</span></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                            ...
                                                            <td class="tb-col">
                                                                <div class="media-group">
                                                                    ...
                                                                    <div class="media-text"><span
                                                                            class="title">Timothy Smith</span><span
                                                                            class="text smaller">Product Manager</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="tb-col tb-col-end"><span
                                                                    class="small">238</span></td>
                                                            <td class="tb-col tb-col-end tb-col-sm">
                                                                <div class="nk-chart-knob js-pureknob" data-size="24"
                                                                    data-value="60" data-track-width="0.3"
                                                                    data-angle-offset="0.4" data-hide-value="true"
                                                                    data-color-fg="#22C55E"></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="tb-col">
                                                                <div class="media-group">
                                                                    <div
                                                                        ...
                                                                        <img src="images/product/b.jpg"
                                                                            alt=""></div>
                                                                    <div class="media-text"><span
                                                                            class="title">Alexis Clarke</span><span
                                                                            class="text smaller">React Developer</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="tb-col tb-col-end"><span
                                                                    class="small">107</span></td>
                                                            <td class="tb-col tb-col-end tb-col-sm">
                                                                <div class="nk-chart-knob js-pureknob" data-size="24"
                                                                    data-value="42" data-track-width="0.3"
                                                                    data-hide-value="true" data-angle-offset="0.4"
                                                                ...
                                                                <div class="media-group">
                                                                    <div
                                                                        ...
                                                                        <img src="images/product/c.jpg"
                                                                            alt=""></div>
                                                                    <div class="media-text"><span
                                                                            class="title">Herbert Stokes</span><span
                                                                            class="text smaller">Lead Designer</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="tb-col tb-col-end"><span
                                                                    class="small">76</span></td>
                                                            <td class="tb-col tb-col-end tb-col-sm">
                                                                <div class="nk-chart-knob js-pureknob" data-size="24"
                                                                    data-value="50" data-track-width="0.3"
                                                                    data-hide-value="true" data-angle-offset="0.4"
                                                                    data-color-fg="#6200EE"></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="tb-col">
                                                                <div class="media-group">
                                                                    <div
                                                                        ...
                                                                        <img src="images/product/d.jpg"
                                                                            alt=""></div>
                                                                    <div class="media-text"><span class="title">Nancy
                                                                            Martino</span><span
                                                                            class="text smaller">UI/UX Designer</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="tb-col tb-col-end"><span
                                                                    class="small">683</span></td>
                                                            <td class="tb-col tb-col-end tb-col-sm">
                                                                <div class="nk-chart-knob js-pureknob" data-size="24"
                                                                    data-value="34" data-track-width="0.3"
                                                                    data-hide-value="true" data-angle-offset="0.4"
                                                                    data-color-fg="#FBBF24"></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="tb-col">
                                                                <div class="media-group">
                                                                    <div
                                                                        ...
                                                                        <img src="images/product/e.jpg"
                                                                            alt=""></div>
                                                                    <div class="media-text"><span
                                                                            class="title">Michael Morris</span><span
                                                                            class="text smaller">Lead Developer</span>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td class="tb-col tb-col-end"><span
                                                                    class="small">395</span></td>
                                                            <td class="tb-col tb-col-end tb-col-sm">
                                                                <div class="nk-chart-knob js-pureknob" data-size="24"
                                                                    data-value="26" data-track-width="0.3"
                                                                    data-hide-value="true" data-angle-offset="0.4"
                                                                    data-color-fg="#6200EE"></div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="tb-col">
                                                                <div class="media-group">
                                                                    <div
                                                                        ...
                                                                        <img src="images/product/b.jpg"
                                                                            alt=""></div>
                                                                    <div class="media-text"><span class="title">Glen
                                                                            Matney</span><span
                                                                            class="text smaller">Lead Designer</span>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td class="tb-col tb-col-end"><span
                                                                    class="small">46</span></td>
                                                            <td class="tb-col tb-col-end tb-col-sm">
                                                                <div class="nk-chart-knob js-pureknob" data-size="24"
                                                                    data-value="46" data-track-width="0.3"
                                                                    data-hide-value="true" data-angle-offset="0.4"
                                                                    data-color-fg="#6200EE"></div>
                                                            </td>
                                                        </tr>
