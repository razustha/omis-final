                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('setting.users.store') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">{{ createText('branch_id', 'branch_id', 'Branch Id') }}
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            {{ createText('email_verified_at', 'email_verified_at', 'Email Verified At') }}
                                        </div>
                                        ...
                                        <div class="col-lg-6">{{ createText('created_by', 'created_by', 'Created By') }}
                                        </div>
                                        <div class="col-lg-6">{{ createText('updated_by', 'updated_by', 'Updated By') }}
                                        </div>
                                        <div class="col-lg-6">
                                            {{ customCreateSelect('status', 'status', '', 'Status', ['1' => 'Active', '0' => 'Inactive']) }}
                                        </div>
                                        <div class="col-lg-6">{{ createText('is_deleted', 'is_deleted', 'Is Deleted') }}
                                        </div> <br>
