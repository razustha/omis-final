        ...
        <div class="nk-block-head-content w-100">
            ...
            <div class="card w-100">
                <div class="p-5">
                    ...
                    <div class="card-body">
                <p><b>Applicant Name Id :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->applicantName_id}}</span></p><p><b>Deparment Name Id :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->deparmentName_id}}</span></p><p><b>Proposal Title :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->proposalTitle}}</span></p><p><b>Proposal Details :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->proposalDetails}}</span></p><p><b>Proposal Submitted By :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->proposalSubmittedBy}}</span></p><p><b>Proposal Submitted To :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->proposalSubmittedTo}}</span></p><p><b>Alias :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->alias}}</span></p><p><b>Status :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span
