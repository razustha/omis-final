            ...
            <div class="container">
                ...
                <div class="nk-block-head-between flex-wrap gap g-2">
                    <div class="nk-block-head-content">
                        <h2 class="nk-block-title">Add Estimates</h1>
...
</div><div class="col-lg-6">{{createDate("estimateDate","estimateDate","EstimateDate")}}
</div><div class="col-lg-12">{{createLabel('remarks','form-label col-form-label','Estimate Details')}}{{createTextArea("estimateDetails",'',"estimateDetails",'',"")}}
</div><div class="col-lg-4">{{createText("totalEstimates","totalEstimates","Total")}}
