@extends('omis.partials.layouts')
        ...
        <div class="nk-content">
            <div class="container">
                ...
                <div class="nk-block-head-between flex-wrap gap g-2">
                    <div class="nk-block-head-content">
                        <h2 class="nk-block-title">Add Cashrequest</h1>
            ...
            <div class="nk-block">
                        ...
                        <div class="card">
                            <div class="card-body">
                <form method="POST" action="{{route('finance.cashrequest.store')}}" enctype="multipart/form-data">
 @csrf 
...
</div><div class="col-lg-4">{{createText("amountWords","amountWords","AmountWords")}}
