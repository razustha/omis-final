<form action="{{route('finance.invoices.store')}}" id="storeCustomForm">
 @csrf 
<div class="row"><div class="col-lg-6">{{createText("company_id","company_id","Company Id")}}
</div><div class="col-lg-6">{{createText("invoicesTitle","invoicesTitle","Invoices Title")}}
</div><div class="col-lg-4">{{createText("amount","amount","Amount")}}
</div><div class="col-lg-4">{{createText("amountInWords","amountInWords","Amount In Words")}}
