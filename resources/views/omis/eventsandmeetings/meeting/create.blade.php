@extends('omis.partials.layouts')
        ...
        <div class="nk-content">
            ...
            <div class="nk-block">
                        ...
                        <div class="card">
                            <div class="card-body">
                <form method="POST" action="{{route('eventsandmeetings.meeting.store')}}" enctype="multipart/form-data">
 @csrf 
<div class="row"><div class="col-lg-6">{{createText("meetingTitle","meetingTitle","MeetingTitle")}}
</div><div class="col-lg-6">{{createDate("meetingDate","meetingDate","MeetingDate",'','','')}}
</div><div class="col-lg-6">{{createInput('time',"meetingTime","meetingTime","MeetingTime")}}
