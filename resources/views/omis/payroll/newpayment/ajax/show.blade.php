        ...
        <div class="nk-block-head-content w-100">
            ...
            <div class="card w-100">
                <div class="p-5">
                    ...
                    <div class="card-body">
                <p><b>EmployeeAccountNumber :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->employeeAccountNumber}}</span></p><p><b>EmployeeName :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->employeeName}}</span></p><p><b>PaidDate :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->paidDate}}</span></p><p><b>PaidAmount :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->paidAmount}}</span></p><p><b>PaymentMethod :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->paymentMethod}}</span></p><p><b>SelectDepartment :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->selectDepartment}}</span></p><p><b>Alias :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->alias}}</span></p><p><b>Status :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span
