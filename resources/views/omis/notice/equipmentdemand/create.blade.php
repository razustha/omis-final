        ...
        <div class="nk-content">
            <div class="container">
                ...
                <div class="nk-block-head-between flex-wrap gap g-2">
                    ...
                    <div class="nk-block-head-content">
                    <ul class="d-flex"> <li>
                        <a href="{{ route('notice.equipmentdemand.index') }}" class="btn btn-md d-md-none btn-primary">
            ...
            <div class="nk-block">
                        ...
                        <div class="card">
                            <div class="card-body">
                <form method="POST" action="{{route('notice.equipmentdemand.store')}}" enctype="multipart/form-data">
 @csrf 
