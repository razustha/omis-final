...
<!-- </div><div class="col-lg-6">{{createLabel('announcementSummary','form-label col-form-label','Announcement Summary')}}{{createTextArea("announcementSummary","announcementSummary","announcementSummary","",'$data->announcementSummary')}} -->
...
</div><div class="col-lg-4">{{createDate("announcementEndDate","announcementEndDate","Announcement EndDate",'',$data->announcementEndDate)}}
