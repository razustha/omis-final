@extends('omis.partials.layouts')
        ...
        <div class="nk-content">
            <div class="container">
                ...
                <div class="nk-block-head-between flex-wrap gap g-2">
                    <div class="nk-block-head-content">
                        <h2 class="nk-block-title">Add Equipmentdemand</h1>
            ...
            <div class="nk-block">
                        ...
                        <div class="card">
                            <div class="card-body">
                <form method="POST" action="{{route('assets.equipmentdemand.store')}}" enctype="multipart/form-data">
 @csrf 
...
</div><div class="col-12">{{createLabel('remarks', 'form-label col-form-label', "Remarks")}}{{createTextArea("remarks",'',"remarks","", "")}}
