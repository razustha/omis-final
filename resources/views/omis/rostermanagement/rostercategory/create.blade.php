@extends('omis.partials.layouts')
        ...
        <div class="nk-content">
            <div class="container">
                ...
                <div class="nk-block-head-between flex-wrap gap g-2">
                    <div class="nk-block-head-content">
                        <h2 class="nk-block-title">Add Rostercategory</h1>

                    </div>
                    <div class="nk-block-head-content">
                    <ul class="d-flex"> <li>
                        <a href="{{ route('rostermanagement.rostercategory.index') }}" class="btn btn-md d-md-none btn-primary">
            ...
            <div class="nk-block">
                        ...
                        <div class="card">
                            <div class="card-body">
                <form method="POST" action="{{route('rostermanagement.rostercategory.store')}}" enctype="multipart/form-data">
 @csrf 
...
</div><div class="col-lg-4">{{createText("applicantName","applicantName","ApplicantName")}}
