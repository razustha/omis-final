                            ...
                            <div class="nk-block-head">
                                <div class="nk-block-head-between flex-wrap gap g-2">
                                    <div class="nk-block-head-content">
                                        <h2 class="nk-block-title">Rostercategory List</h1>
                                            <nav>
                                                <ol class="breadcrumb breadcrumb-arrow mb-0">
                                                    <li class="breadcrumb-item"><a href="#">Rostercategory</a></li>
                                                    <li class="breadcrumb-item"><a href="#">Rostercategory Manage</a></li>
                                                    <li class="breadcrumb-item active" aria-current="page">Rostercategory
                                                    </li>
                                                </ol>
                                            </nav>
                                    </div>
                                    <div class="nk-block-head-content">
                                        <ul class="d-flex">
                                            <button class="btn btn-primary btn-add" data-bs-toggle="offcanvas" data-bs-target="#addOffcanvas">  <em class="icon ni ni-plus"></em>Add Rostercategory</button>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<td class="tb-col">
                                                   ...
                                                   <li> <button class="btn btn-color-primary btn-hover-primary btn-icon btn-soft btn-editModal" data-route="{{route('rostermanagement.rostercategory.edit',[$item->rostercateogry_id])}}" data-bs-toggle="offcanvas" data-bs-target="#editoffcanvas">  <em
                           ...
                           <div class="addoffcanvas offcanvas offcanvas-end offcanvas-size-xxlg" id="addOffcanvas">
                            <div class="offcanvas-header border-bottom border-light">
                                <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Rostercategory</h5><button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                            </div>
                            <div class="offcanvas-body" data-simplebar>
                              <div class="card h-100">
                                    <div class="card-body">
                                        <form >
 <input type="hidden" name="_token" value="gQzTGhK2UDjyDw7G9l34BG9m94HkzRYW9RUzc5dm"> 
<div class="row"><div class="col-lg-6">            <label for="titleName" class="form-label col-form-label"> TitleName </label>
            <div class="form-control-wrap">
                <input type="text" id="titleName" placeholder="" name="titleName" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="titleType_id" class="form-label col-form-label"> TitleType Id </label>
            <div class="form-control-wrap">
                <input type="text" id="titleType_id" placeholder="" name="titleType_id" class="form-control " value="">
            </div>
...
</div><div class="col-lg-6">            <label for="officerName" class="form-label col-form-label"> OfficerName </label>
            <div class="form-control-wrap">
                <input type="text" id="officerName" placeholder="" name="officerName" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="applicants_id" class="form-label col-form-label"> Applicants Id </label>
            <div class="form-control-wrap">
                <input type="text" id="applicants_id" placeholder="" name="applicants_id" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="applicantName" class="form-label col-form-label"> ApplicantName </label>
            <div class="form-control-wrap">
                <input type="text" id="applicantName" placeholder="" name="applicantName" class="form-control " value="">
            </div>
                ...
                <input type="text" id="remarks" placeholder="" name="remarks" class="form-control " value="">
                    ...
                    Submit                </button>
                            ...
                            <div class="offcanvas offcanvas-end offcanvas-size-xxlg editoffcanvas" id="editoffcanvas">
                                <div class="offcanvas-header border-bottom border-light">
                                    <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Rostercategory</h5><button type="button" class="btn-close"
