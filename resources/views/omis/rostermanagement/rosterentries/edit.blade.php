@extends('omis.partials.layouts')
        ...
        <div class="nk-content">
            <div class="container">
                ...
                <div class="nk-block-head-between flex-wrap gap g-2">
                    <div class="nk-block-head-content">
                        <h2 class="nk-block-title">Edit Rosterentries</h1>

                    </div>
                    <div class="nk-block-head-content">
                    <ul class="d-flex"> <li>
                        <a href="{{ route('rostermanagement.rosterentries.index') }}" class="btn btn-md d-md-none btn-primary">
            ...
            <div class="nk-block">
                        ...
                        <div class="card">
                            <div class="card-body">
                <form method="POST" action="{{route('rostermanagement.rosterentries.update',[$data->rosterentries_id])}}" enctype="multipart/form-data">
 @csrf 
 @method('PUT')
...
</div><div class="col-lg-4">{{createText("applicantName_id","applicantName_id","ApplicantName Id",'',$data->applicantName_id)}}
...
</div><div class="col-lg-12">{{createLabel("remarks",'form-label col-form-label','Remarks')}}{{createTextArea("remarks","remarks","",'',$data->remarks)}}</div> 
