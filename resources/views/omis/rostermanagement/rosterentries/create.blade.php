@extends('omis.partials.layouts')
        ...
        <div class="nk-content">
            <div class="container">
                ...
                <div class="nk-block-head-between flex-wrap gap g-2">
                    <div class="nk-block-head-content">
                        <h2 class="nk-block-title">Add Rosterentries</h1>
            ...
            <div class="nk-block">
                        ...
                        <div class="card">
                            <div class="card-body">
                <form method="POST" action="{{route('rostermanagement.rosterentries.store')}}" enctype="multipart/form-data">
 @csrf 
<div class="row"><div class="col-lg-6">{{createText("entryType_id","entryType_id","EntryType Id")}}
</div><div class="col-lg-6">{{createLabel("time",'form-label col-form-label','Time')}}{{createInput("time","time","time",'','')}}
</div><div class="col-lg-6">{{createDate("date","date","Date",'','','')}}
</div><div class="col-lg-6">{{createText("officerName","officerName","OfficerName")}}
</div><div class="col-lg-4">{{createText("applicantName_id","applicantName_id","ApplicantName Id")}}
