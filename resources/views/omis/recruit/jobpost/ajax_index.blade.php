                            ...
                            <div class="nk-block-head">
                                <div class="nk-block-head-between flex-wrap gap g-2">
                                    <div class="nk-block-head-content">
                                        <h2 class="nk-block-title">Jobpost List</h1>
                                            <nav>
                                    ...
                                    <div class="nk-block-head-content">
                                        <ul class="d-flex">
                                            <button class="btn btn-primary btn-add" data-bs-toggle="offcanvas" data-bs-target="#addOffcanvas">  <em class="icon ni ni-plus"></em>Add Jobpost</button>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<td class="tb-col">
                                                   ...
                                                   <li> <button class="btn btn-color-primary btn-hover-primary btn-icon btn-soft btn-addCity" data-route="{{route('recruit.jobpost.edit',[$item->jobpost_id])}}" data-bs-toggle="offcanvas" data-bs-target="#editoffcanvas">  <em
                           ...
                           <div class="addoffcanvas offcanvas offcanvas-end offcanvas-size-xxlg" id="addOffcanvas">
                            <div class="offcanvas-header border-bottom border-light">
                                <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Jobpost</h5><button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                            </div>
...
<div class="row"><div class="col-lg-6">            <label for="jobTitle" class="form-label col-form-label"> JobTitle </label>
            <div class="form-control-wrap">
                <input type="text" id="jobTitle" placeholder="" name="jobTitle" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="jobType" class="form-label col-form-label"> JobType </label>
            <div class="form-control-wrap">
                <input type="text" id="jobType" placeholder="" name="jobType" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="vacancyNumber" class="form-label col-form-label"> VacancyNumber </label>
            <div class="form-control-wrap">
                <input type="text" id="vacancyNumber" placeholder="" name="vacancyNumber" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="closingDate" class="form-label col-form-label"> ClosingDate </label>
            <div class="form-control-wrap">
                <input type="text" id="closingDate" placeholder="" name="closingDate" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="jobCategory" class="form-label col-form-label"> JobCategory </label>
            <div class="form-control-wrap">
                <input type="text" id="jobCategory" placeholder="" name="jobCategory" class="form-control " value="">
            </div>
                ...
                <input type="text" id="remarks" placeholder="" name="remarks" class="form-control " value="">
                    ...
                    Submit                </button>
                            ...
                            <div class="offcanvas offcanvas-end offcanvas-size-xxlg editoffcanvas" id="editoffcanvas">
                                <div class="offcanvas-header border-bottom border-light">
                                    <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Jobpost</h5><button type="button" class="btn-close"
