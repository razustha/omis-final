@extends('omis.partials.layouts')
        ...
        <div class="nk-content">
            <div class="container">
                ...
                <div class="nk-block-head-between flex-wrap gap g-2">
                    <div class="nk-block-head-content">
                        <h2 class="nk-block-title">Edit Organizationcategory</h1>

                    </div>
                    <div class="nk-block-head-content">
                    <ul class="d-flex"> <li>
                        <a href="{{ route('master.organizationcategory.index') }}" class="btn btn-md d-md-none btn-primary">
            ...
            <div class="nk-block">
                        ...
                        <div class="card">
                            <div class="card-body">
                <form method="POST" action="{{route('master.organizationcategory.update',[$data->organizationcategory_id])}}" enctype="multipart/form-data">
 @csrf 
 @method('PUT')
