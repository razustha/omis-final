...
</div><div class="col-lg-6">{{createText("numberOfLeave","numberOfLeave","Number Of Leave",'',$data->numberOfLeave)}}
</div><div class="col-lg-6">{{createText("monthlyLimit","monthlyLimit","Monthly Limit",'',$data->monthlyLimit)}}
</div><div class="col-lg-4">{{createText("colorCode","colorCode","Color Code",'',$data->colorCode)}}
</div><div class="col-lg-4">{{createText("assignEmployee","assignEmployee","Assign Employee",'',$data->assignEmployee)}}
