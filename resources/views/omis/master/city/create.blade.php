                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-between flex-wrap gap g-2">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title">Add City</h1>

                            </div>
                            <div class="nk-block-head-content">
                                <ul class="d-flex">
                                    <li>
                                        <a href="{{ route('master.city.index') }}" class="btn btn-md d-md-none btn-primary">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="{{ route('master.city.store') }}"
                                    ...
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-6">{{ createText('country_id', 'country_id', 'Country Id') }}
                                        </div>
                                        <div class="col-lg-6">{{ createText('state_id', 'state_id', 'State Id') }}
                                        </div>
                                        <div class="col-lg-6">{{ createText('district_id', 'district_id', 'District Id') }}
                                        </div>
