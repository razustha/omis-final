...
<td class="tb-col">
                                                ...
                                                <li>    
                                                    {!! actionCanvasButton("","btn-showCanvas","showoffcanvas","eye",'training.traininglist.show',$item->traininglist_id) !!}
                                                </li>
                                               <li> 
                                                        {!! actionCanvasButton("","btn-editCanvas","editoffcanvas","edit",'training.traininglist.edit',$item->traininglist_id) !!}
                                                </li>
                                                <li>{!! deleteCanvasButton("","btn-hover-danger",'training.traininglist.destroy',$item->traininglist_id) !!}</li>
                                               </ul> </td>
                                               </tr>
