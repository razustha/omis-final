                            ...
                            <div class="nk-block-head">
                                <div class="nk-block-head-between flex-wrap gap g-2">
                                    <div class="nk-block-head-content">
                                        <h2 class="nk-block-title">Leavereports List</h1>
                                            <nav>
                                    ...
                                    <div class="nk-block-head-content">
                                        <ul class="d-flex">
                                            <button class="btn btn-primary btn-add" data-bs-toggle="offcanvas" data-bs-target="#addOffcanvas">  <em class="icon ni ni-plus"></em>Add Leavereports</button>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<td class="tb-col">
                                                   ...
                                                   <li> <button class="btn btn-color-primary btn-hover-primary btn-icon btn-soft btn-addCity" data-route="{{route('reports.leavereports.edit',[$item->leaveReports_id])}}" data-bs-toggle="offcanvas" data-bs-target="#editoffcanvas">  <em
                           ...
                           <div class="addoffcanvas offcanvas offcanvas-end offcanvas-size-xxlg" id="addOffcanvas">
                            <div class="offcanvas-header border-bottom border-light">
                                <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Leavereports</h5><button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                            </div>
...
</div><div class="col-lg-6">            <label for="leaveReason" class="form-label col-form-label"> LeaveReason </label>
            <div class="form-control-wrap">
                <input type="text" id="leaveReason" placeholder="" name="leaveReason" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="leaveApprovedBy" class="form-label col-form-label"> LeaveApprovedBy </label>
            <div class="form-control-wrap">
                <input type="text" id="leaveApprovedBy" placeholder="" name="leaveApprovedBy" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="totalLeaveDays" class="form-label col-form-label"> TotalLeaveDays </label>
            <div class="form-control-wrap">
                <input type="text" id="totalLeaveDays" placeholder="" name="totalLeaveDays" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="leaveDate" class="form-label col-form-label"> LeaveDate </label>
            <div class="form-control-wrap">
                <input type="text" id="leaveDate" placeholder="" name="leaveDate" class="form-control " value="">
            </div>
                ...
                <input type="text" id="remarks" placeholder="" name="remarks" class="form-control " value="">
                    ...
                    Submit                </button>
                            ...
                            <div class="offcanvas offcanvas-end offcanvas-size-xxlg editoffcanvas" id="editoffcanvas">
                                <div class="offcanvas-header border-bottom border-light">
                                    <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Leavereports</h5><button type="button" class="btn-close"
