<div class="offcanvas-header border-bottom border-light">
        <h5 class="offcanvas-title" id="offcanvasTopLabel">Show Attendance Reports</h5><button type="button" class="btn-close"
    ...
    <div class="offcanvas-body" data-simplebar>
        <div class="nk-block-head-content w-100">
            <div class="d-flex justify-content-between pb-4">
                ...
                <h2>Attendance Reports Details</h2>
            ...
            <div class="card w-100">
                <div class="p-5">
                    ...
                    <div class="card-body">
                <p><b>Applicant :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->applicants_id}}</span></p><p><b>Total Attendance :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->totalAttendance}}</span></p><p><b>Total Working Days :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->totalWorkingDays}}</span></p><p><b>Total Absent Days :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->totalAbsentDays}}</span></p><p><b>Attendance Report By :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->attendanceReportBy}}</span></p><p><b>Issue Date :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->issueDate}}</span></p><p><b>Alias :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->alias}}</span></p><p><b>Status :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span
