                        ...
                        <div class="nk-content-body">
                            <div class="nk-block-head">
                                <div class="nk-block-head-between flex-wrap gap g-2">
                                    ...
                                    <div class="nk-block-head-content">
                                        <ul class="d-flex">
                                            <button class="btn btn-primary btn-add" data-bs-toggle="offcanvas" data-bs-target="#addOffcanvas">  <em class="icon ni ni-plus"></em>Add Attendancereports</button>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<td class="tb-col">
                                                   ...
                                                   <li> <button class="btn btn-color-primary btn-hover-primary btn-icon btn-soft btn-addCity" data-route="{{route('reports.attendancereports.edit',[$item->attendancereports_id])}}" data-bs-toggle="offcanvas" data-bs-target="#editoffcanvas">  <em
                           ...
                           <div class="addoffcanvas offcanvas offcanvas-end offcanvas-size-xxlg" id="addOffcanvas">
                            <div class="offcanvas-header border-bottom border-light">
                                <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Attendancereports</h5><button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                            </div>
...
</div><div class="col-lg-6">            <label for="totalAttendance" class="form-label col-form-label"> TotalAttendance </label>
            <div class="form-control-wrap">
                <input type="text" id="totalAttendance" placeholder="" name="totalAttendance" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="totalWorkingDays" class="form-label col-form-label"> TotalWorkingDays </label>
            <div class="form-control-wrap">
                <input type="text" id="totalWorkingDays" placeholder="" name="totalWorkingDays" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="totalAbsentDays" class="form-label col-form-label"> TotalAbsentDays </label>
            <div class="form-control-wrap">
                <input type="text" id="totalAbsentDays" placeholder="" name="totalAbsentDays" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="attendanceReportBy" class="form-label col-form-label"> AttendanceReportBy </label>
            <div class="form-control-wrap">
                <input type="text" id="attendanceReportBy" placeholder="" name="attendanceReportBy" class="form-control " value="">
            </div>
                ...
                <input type="text" id="remarks" placeholder="" name="remarks" class="form-control " value="">
                    ...
                    Submit                </button>
                            ...
                            <div class="offcanvas offcanvas-end offcanvas-size-xxlg editoffcanvas" id="editoffcanvas">
                                <div class="offcanvas-header border-bottom border-light">
                                    <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Attendancereports</h5><button type="button" class="btn-close"
