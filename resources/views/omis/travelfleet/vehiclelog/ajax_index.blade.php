...
<td class="tb-col">
                                                ...
                                                <li>    
                                                    {!! actionCanvasButton("","btn-showCanvas","showoffcanvas","eye",'travelfleet.vehiclelog.show',$item->vehiclelog_id) !!}
                                                </li>
                                               <li> 
                                                        {!! actionCanvasButton("","btn-editCanvas","editoffcanvas","edit",'travelfleet.vehiclelog.edit',$item->vehiclelog_id) !!}
                                                </li>
                                                <li>{!! deleteCanvasButton("","btn-hover-danger",'travelfleet.vehiclelog.destroy',$item->vehiclelog_id) !!}</li>
                                               </ul> </td>
                                               </tr>
