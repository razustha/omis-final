                        ...
                        <div class="nk-content-body">
                            <div class="nk-block-head">
                                <div class="nk-block-head-between flex-wrap gap g-2">
                                    ...
                                    <div class="nk-block-head-content">
                                        <ul class="d-flex">
                                            <button class="btn btn-primary btn-add" data-bs-toggle="offcanvas" data-bs-target="#addOffcanvas">  <em class="icon ni ni-plus"></em>Add Vehiclelog</button>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<td class="tb-col">
                                                    ...
                                                    <li><a href="{{route('travelfleet.vehiclelog.show',[$item->vehiclelog_id])}}" type="button" class="btn btn-color-success btn-hover-success btn-icon btn-soft" ><em class="icon ni ni-eye"></em></a></li>
                                                   <li> <button class="btn btn-color-primary btn-hover-primary btn-icon btn-soft btn-addCity" data-route="{{route('travelfleet.vehiclelog.edit',[$item->vehiclelog_id])}}" data-bs-toggle="offcanvas" data-bs-target="#editoffcanvas">  <em
                                                            class="icon ni ni-edit"></em></button> </li>
                                                    <li><button type="button" data-route="{{route('travelfleet.vehiclelog.destroy',[$item->vehiclelog_id])}}" class="btn btn-color-danger btn-hover-danger btn-icon btn-soft"><em class="icon ni ni-trash"></em></button></li>
                                                   </ul> </td>
                                                   <tr>
...
<div class="row"><div class="col-lg-6">            <label for="riderName" class="form-label col-form-label"> RiderName </label>
            <div class="form-control-wrap">
                <input type="text" id="riderName" placeholder="" name="riderName" class="form-control " value="">
            </div>
...
</div><div class="col-lg-6">            <label for="arrivalTime" class="form-label col-form-label"> ArrivalTime </label>
            <div class="form-control-wrap">
                <input type="text" id="arrivalTime" placeholder="" name="arrivalTime" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="departureTime" class="form-label col-form-label"> DepartureTime </label>
            <div class="form-control-wrap">
                <input type="text" id="departureTime" placeholder="" name="departureTime" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="from" class="form-label col-form-label"> From </label>
            <div class="form-control-wrap">
                <input type="text" id="from" placeholder="" name="from" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="to" class="form-label col-form-label"> To </label>
            <div class="form-control-wrap">
                <input type="text" id="to" placeholder="" name="to" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="purpose" class="form-label col-form-label"> Purpose </label>
            <div class="form-control-wrap">
                <input type="text" id="purpose" placeholder="" name="purpose" class="form-control " value="">
            </div>
                ...
                <input type="text" id="remarks" placeholder="" name="remarks" class="form-control " value="">
                    ...
                    Submit                </button>
                            ...
                            <div class="offcanvas offcanvas-end offcanvas-size-xxlg editoffcanvas" id="editoffcanvas">
                                <div class="offcanvas-header border-bottom border-light">
                                    <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Vehiclelog</h5><button type="button" class="btn-close"
