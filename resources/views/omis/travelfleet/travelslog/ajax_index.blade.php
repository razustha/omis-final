...
<td class="tb-col">
                                                ...
                                                <li>    
                                                    {!! actionCanvasButton("","btn-showCanvas","showoffcanvas","eye",'travelfleet.travelslog.show',$item->travelslog_id) !!}
                                                </li>
                                               <li> 
                                                        {!! actionCanvasButton("","btn-editCanvas","editoffcanvas","edit",'travelfleet.travelslog.edit',$item->travelslog_id) !!}
                                                </li>
                                                <li>{!! deleteCanvasButton("","btn-hover-danger",'travelfleet.travelslog.destroy',$item->travelslog_id) !!}</li>
                                               </ul> </td>
                                               </tr>
                       ...
                       <div class="addoffcanvas offcanvas offcanvas-end offcanvas-size-xxlg" id="addOffcanvas">
                        <div class="offcanvas-header border-bottom border-light">
                            <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Travel Service Log</h5><button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                        </div>
                        <div class="offcanvas-body" data-simplebar>
                          <div class="card h-100">
                            ...
                            <div class="offcanvas-header border-bottom border-light">
                                <h5 class="offcanvas-title" id="offcanvasTopLabel">Edit Travel Service Log<h5><button type="button" class="btn-close"
