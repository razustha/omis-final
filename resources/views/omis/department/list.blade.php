...
<div class="nk-content">
    <div class="container-fluid">
        <div class="nk-content-inner">
            <?php if (!empty($TableRows)) : ?><?php $TableCols = array_keys((array)$TableRows[0]);
                                            $Table_pk = $TableCols[0]; ?><table class="datatable-init table" data-nk-container="table-responsive table-border">
                <thead>
                    <tr>
