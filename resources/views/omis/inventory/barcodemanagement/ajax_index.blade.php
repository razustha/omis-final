                    ...
                    <div class="nk-content-body">
                        <div class="nk-block-head">
                            <div class="nk-block-head-between flex-wrap gap g-2">
                                ...
                                <div class="nk-block-head-content">
                                    <ul class="d-flex">
                                        {!!createCanvasButton("customBtnAdd","","Barcode Management","inventory.barcodemanagement.create") !!}
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<td class="tb-col">
                                                ...
                                                <li>    
                                                    {!! actionCanvasButton("","btn-showCanvas","showoffcanvas","eye",'inventory.barcodemanagement.show',$item->barcodemanagement_id) !!}
                                                </li>
                                               <li> 
                                                        {!! actionCanvasButton("","btn-editCanvas","editoffcanvas","edit",'inventory.barcodemanagement.edit',$item->barcodemanagement_id) !!}
                                                </li>
                                                <li>{!! deleteCanvasButton("","btn-hover-danger",'inventory.barcodemanagement.destroy',$item->barcodemanagement_id) !!}</li>
                                               </ul> </td>
                                               </tr>
