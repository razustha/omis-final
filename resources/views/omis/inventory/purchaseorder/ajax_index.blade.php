                        ...
                        <div class="nk-block-head">
                            <div class="nk-block-head-between flex-wrap gap g-2">
                                <div class="nk-block-head-content">
                                    <h2 class="nk-block-title">Purchase Order List</h1>
                                        <nav>
                                            <ol class="breadcrumb breadcrumb-arrow mb-0">
                                                <li class="breadcrumb-item"><a href="#">Purchase Order</a></li>
                                                <li class="breadcrumb-item"><a href="#">Purchase Order Manage</a></li>
                                                <li class="breadcrumb-item active" aria-current="page">Purchase Order
                                                </li>
                                            </ol>
                                        </nav>
                                </div>
                                <div class="nk-block-head-content">
                                    <ul class="d-flex">
                                        {!!createCanvasButton("customBtnAdd","","Purchase Order","inventory.purchaseorder.create") !!}
                                    </ul>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tb-col">
                                                ...
                                                <li>    
                                                    {!! actionCanvasButton("","btn-showCanvas","showoffcanvas","eye",'inventory.purchaseorder.show',$item->purchaseorder_id) !!}
                                                </li>
                                               <li> 
                                                        {!! actionCanvasButton("","btn-editCanvas","editoffcanvas","edit",'inventory.purchaseorder.edit',$item->purchaseorder_id) !!}
                                                </li>
                                                <li>{!! deleteCanvasButton("","btn-hover-danger",'inventory.purchaseorder.destroy',$item->purchaseorder_id) !!}</li>
                                               </ul> </td>
                                               </tr>
