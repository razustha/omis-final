@extends('omis.partials.layouts')
        ...
        <div class="nk-content">
            <div class="container">
                ...
                <div class="nk-block-head-between flex-wrap gap g-2">
                    <div class="nk-block-head-content">
                        <h2 class="nk-block-title">Edit Goodreceivedreconcile</h1>
            ...
            <div class="nk-block">
                        ...
                        <div class="card">
                            <div class="card-body">
                <form method="POST" action="{{route('inventory.goodreceivedreconcile.update',[$data->goodreceivedreconcile_id])}}" enctype="multipart/form-data">
 @csrf 
 @method('PUT')
