                ...
                <div class="nk-content-body">
                    ...
                    <div class="nk-block">
                        <div class="card">
                                        ...
                                        <tr>
                                            ...
                                            <td class="tb-col">
                                                ...
                                                <li>
                                                    ...
                                                    <li>
                                                        {!! actionCanvasButton('', 'btn-editCanvas', 'editoffcanvas', 'edit', 'hr.warnings.edit', $item->warnings_id) !!}
                                                    </li>
                                                    <li>{!! deleteCanvasButton('', 'btn-hover-danger', 'hr.warnings.destroy', $item->warnings_id) !!}</li>
                                                </ul>
                                            </td>
                                        </tr>
                                    @endforeach
                            ...
                            <div class="addoffcanvas offcanvas offcanvas-end offcanvas-size-xxlg" id="addOffcanvas">
                                <div class="offcanvas-header border-bottom border-light">
                                    <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Warnings</h5><button
                        ...
                        <div class="offcanvas offcanvas-end offcanvas-size-xxlg editoffcanvas" id="editoffcanvas">
                            <div class="offcanvas-header border-bottom border-light">
                                <h5 class="offcanvas-title" id="offcanvasTopLabel">Edit Warnings<h5><button type="button"
