 ...
 @csrf 
 @method('PUT')
<div class="row"><div class="col-lg-6">{!! getSelectForForeignColumn("tbl_employee","employee_id","firstName",'',$data) !!}
</div><div class="col-lg-6">{{createDate("dateOfTransfer","dateOfTransfer","Date Of Transfer",'',$data->dateOfTransfer)}}
</div><div class="col-lg-6">{{createText("employeeName_id","employeeName_id","Employee Id",'',$data->employeeName_id)}}
</div><div class="col-lg-6">{{createText("fromDepartment","fromDepartment","From Department",'',$data->fromDepartment)}}
