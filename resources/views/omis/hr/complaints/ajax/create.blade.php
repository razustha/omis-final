 ...
 @csrf 
<div class="row"><div class="col-lg-6">{{createText("companyName","companyName","Company Name")}}
</div><div class="col-lg-6">{{createText("companyTitle","companyTitle","Company Title")}}
</div><div class="col-lg-6">{{createDate("complaintDate","complaintDate","Complaint Date")}}
