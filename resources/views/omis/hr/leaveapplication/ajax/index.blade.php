            ...
            <tr>
                ...
                <td class="tb-col">
                    <ul class="d-flex flex-wrap ">
                        <li><a href="{{ route('hr.leaveapplication.show', [$item->leaveApplication_id]) }}"
                                type="button" class="btn btn-color-success btn-hover-success btn-icon btn-soft"><em
                                    class="icon ni ni-eye"></em></a></li>
                        <li><a href="{{ route('hr.leaveapplication.edit', [$item->leaveApplication_id]) }}"
                                type="button" class="btn btn-color-primary btn-hover-primary btn-icon btn-soft"
                                data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                title="Edit"> <em class="icon ni ni-edit"></em></a></li>
                        <li><button type="button"
                                data-route="{{ route('hr.leaveapplication.destroy', [$item->leaveApplication_id]) }}"
