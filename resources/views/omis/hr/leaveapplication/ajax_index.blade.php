            ...
            <div class="nk-content-body">
                <div class="nk-block-head">
                    <div class="nk-block-head-between flex-wrap gap g-2">
                        ...
                        <div class="nk-block-head-content">
                            <ul class="d-flex">
                                {!! createCanvasButton('customBtnAdd', '', 'Leave Application',
                                ...
                                <tr>
                                    ...
                                    <td class="tb-col">
                                        <ul class="d-flex flex-wrap ">
                                            ...
                                            <li>{!! deleteCanvasButton('', 'btn-hover-danger',
                                                'hr.leaveapplication.destroy', $item->leaveApplication_id) !!}</li>


                                            @if ($item->leaveApplication_status == null &&
                                            auth()->user()->employee->is_head == 'manager')

                                            <li>
                                                <button type="button"
                                                    class="btn btn-color-info btn-hover-info btn-icon btn-soft"
                                                    onclick="forwardthis({{ $item->leaveApplication_id }})" value="1"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    data-bs-custom-class="custom-tooltip" title="Forward To Hr"> <em
                                                        class="icon ni ni-forward"></em></button>
                                            </li>
                                            <li>
                                                <button type="button"
                                                    class="btn btn-color-danger btn-hover-danger btn-icon btn-soft"
                                                    onclick="rejectthis({{ $item->leaveApplication_id }})" value="0"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <li>
                                                <button type="button"
                                                    class="btn btn-color-info btn-hover-info btn-icon btn-soft"
                                                    onclick="approvedthis({{ $item->leaveApplication_id }})" value="1"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    data-bs-custom-class="custom-tooltip" title="Approved Leave"> <em
                                                        class="icon ni ni-forward"></em></button>
                                            </li>
                                            <li>
                                                <button type="button"
                                        ...
                                        <ul class="d-flex flex-wrap ">
                                            ...
                                            <li>
                                                <button type="button"
                                                    ...
                                                    onclick="rejectthis({{ $item->leaveApplication_id }})" value="0"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    data-bs-custom-class="custom-tooltip" title="Reject Leave"> <em
                                                        class="icon ni ni-cross-circle"></em></button>
                                            </li>
                                        </ul>
                                    </td>
            ...
            <form action="{{ route('master.leavetype.store') }}" id="storeCustomForm" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            {{ customCreateSelect('leavePaidStatus', 'leavePaidStatus', '', 'Leave Paid Status',
                            ['Paid', 'Unpaid']) }}
                        </div>
                        ...
                        <div class="col-lg-6">
                            {{ customCreateSelect('status', 'status', '', 'Status', ['1' => 'Active', '0' =>
                            'Inactive']) }}
                        </div>
                        <div class="col-lg-12">
                            {{ createLabel('remarks', 'form-label col-from-label', 'Remarks') }}{{
                            createTextArea('remarks', '', 'remarks', '', '') }}
                        </div>
