        ...
        <div class="nk-block-head-content w-100">
            ...
            <div class="card w-100">
                <div class="p-5">
                    ...
                    <div class="card-body">
                <p><b>Appreciation Title :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->appreciationTitle}}</span></p><p><b>Appreciation Type :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->appreciationType}}</span></p><p><b>Appreciated By :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->appreciatedBy}}</span></p><p><b>Recieved By :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->recievedBy}}</span></p><p><b>Appreciation Recieved On :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->appreciationRecievedOn}}</span></p><p><b>Appreciatioan Approved On :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->appreciatioanApprovedOn}}</span></p><p><b>Alias :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->alias}}</span></p><p><b>Status :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span
