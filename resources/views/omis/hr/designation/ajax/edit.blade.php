 ...
 @csrf 
 @method('PUT')
<div class="row"><div class="col-lg-4">{{createText("designationName","designationName","Designation Name",'',$data->designationName)}}
<!-- </div><div class="col-lg-6">{{createText("compnayName_id","compnayName_id","CompnayName Id",'',$data->compnayName_id)}} -->
</div><div class="col-lg-4">{!! getSelectForForeignColumn("tbl_department","department_id","departmentName",'',$data) !!}
