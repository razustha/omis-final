...
</div><div class="col-lg-4">{{createDate("eventStartDate","eventStartDate","Event Start Date",'',$data->eventStartDate)}}
</div><div class="col-lg-4">{{createDate("eventEndDate","eventEndDate","Event End Date",'',$data->eventEndDate)}}
