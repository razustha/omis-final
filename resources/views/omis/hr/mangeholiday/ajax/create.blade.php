<form action="{{route('hr.mangeholiday.store')}}" id="storeCustomForm">
 @csrf 
<div class="row"><div class="col-lg-6">{{createText("companyName_id","companyName_id","Company Id")}}
</div><div class="col-lg-6">{{createText("title","title","Title")}}
</div><div class="col-lg-4">{{createDate("eventStartDate","eventStartDate","Event Start Date")}}
</div><div class="col-lg-4">{{createDate("eventEndDate","eventEndDate","Event End Date")}}
