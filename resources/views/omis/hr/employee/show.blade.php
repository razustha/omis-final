                            ...
                            <div class="nk-block-head-between flex-wrap gap g-2 align-items-start">
                                <div class="nk-block-head-content">
                                    <div class="d-flex flex-column flex-md-row align-items-md-center">
                                        <div class="media media-huge media-circle"><img src="images/avatar/a.jpg"
                                                class="img-thumbnail" alt=""></div>
                                        <div class="mt-3 mt-md-0 ms-md-3">
                                            <h3 class="title mb-1">{{ $data->firstName }}</h3><span
                                                class="small">{{ $data->designation_id }}</span>
                                            <ul class="nk-list-option pt-1">
                                                <li><em class="icon ni ni-map-pin"></em><span
                                                        class="small">{{ $data->emailAddress }}</span></li>
                                                <li><em class="icon ni ni-building"></em><span class="small">Bibhuti
                                                        Solutions</span></li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="nk-block-head-between gap g-2">
                            <div class="gap-col">
                                <ul class="nav nav-pills nav-pills-border gap g-3">
                                    ...
                                    <li class="nav-item"><button class="nav-link" data-bs-toggle="tab"
                                            data-bs-target="#projects" type="button"> Project </button></li>
                                    <li class="nav-item"><button class="nav-link" data-bs-toggle="tab"
                                            data-bs-target="#tasks" type="button"> Tasks </button></li>
                                    <li class="nav-item"><button class="nav-link" data-bs-toggle="tab"
                                            data-bs-target="#leaves" type="button"> Leaves </button></li>
                                    <li class="nav-item"><button class="nav-link" data-bs-toggle="tab"
                                            data-bs-target="#timelogs" type="button"> Time Logs </button></li>
                                    <li class="nav-item"><button class="nav-link" data-bs-toggle="tab"
                                            data-bs-target="#travel" type="button"> Travel </button></li>
                                    <li class="nav-item"><button class="nav-link" data-bs-toggle="tab"
                                            data-bs-target="#appreciation" type="button"> Appreciation </button></li>
                                    <li class="nav-item"><button class="nav-link" data-bs-toggle="tab"
                                            data-bs-target="#shiftroaster" type="button"> Shift Roaster </button></li>
                                    <li class="nav-item"><button class="nav-link" data-bs-toggle="tab"
                                            data-bs-target="#permission" type="button"> Permission </button></li>
                                </ul>
                            </div>
                            <!--
                                            <div class="gap-col">
                    ...
                    <div class="nk-block">
                        <div class="tab-content" id="myTabContent">
                                                ...
                                                <div class="bio-block">
                                                    ...
                                                    <ul class="list-group list-group-borderless small">
                                                        <li class="list-group-item"><span
                                                                class="title fw-medium w-40 d-inline-block">Employee
                                                                ID:</span><span class="text">
                                                                {{ $data->employee_id }}</span></li>
                                                        <li class="list-group-item"><span
                                                                class="title fw-medium w-40 d-inline-block">Full
                                                                Name:</span><span class="text">{{ $data->firstName }}
                                                                {{ $data->middleName }} {{ $data->lastName }}</span></li>
                                                        <li class="list-group-item"><span
                                                                class="title fw-medium w-40 d-inline-block">Email:</span><span
                                                                class="text">{{ $data->emailAddress }}</span></li>
                                                        <li class="list-group-item"><span
                                                        ...
                                                        <li class="list-group-item"><span
                                                                ...
                                                                Date</span><span
                                                                class="text">{{ $data->createdAt }}</span></li>
                                                    </ul>
                                                </div>
                                                <div class="bio-block">
                                                    ...
                                                    <ul class="d-flex flex-wrap gap gx-1">
                                                        <li><a href="#"
                                                                class="badge text-bg-secondary-soft">Photoshop</a></li>
                                                        <li><a href="#"
                                                                class="badge text-bg-secondary-soft">illustrator</a></li>
                                                        <li><a href="#"
                                                                class="badge text-bg-secondary-soft">HTML</a></li>
                                                        <li><a href="#" class="badge text-bg-secondary-soft">CSS</a>
                                                        </li>
                                                        <li><a href="#"
                                                                class="badge text-bg-secondary-soft">Javascript</a></li>
                                                        <li><a href="#"
                                                                class="badge text-bg-secondary-soft">React</a></li>
                                                        <li><a href="#" class="badge text-bg-secondary-soft">Vue</a>
                                                        </li>
                                                        <li><a href="#"
                                                                class="badge text-bg-secondary-soft">Angular</a></li>
                                                        <li><a href="#"
                                                                class="badge text-bg-secondary-soft">Python</a></li>
                                                    </ul>
                                                </div>
                                                <div class="bio-block">
                                                    ...
                                                    <ul class="d-flex flex-wrap gap g-2">
                                                        <li><a href="#"
                                                                class="media media-sm media-middle text-bg-dark"><em
                                                                    class="icon ni ni-github-circle"></em></a></li>
                                                        <li><a href="#"
                                                                class="media media-sm media-middle text-bg-danger"><em
                                                                    class="icon ni ni-dribbble"></em></a></li>
                                                        <li><a href="#"
                                                        ...
                                                        <li class="nk-schedule-item">
                                                            <div class="nk-schedule-item-inner">
                                                                ...
                                                                <div class="nk-schedule-content"><span
                                                                    ...
                                                                    <div class="h6">Invitation for creative designs
                                                                        pattern</div>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="nk-schedule-item">
                                                            <div class="nk-schedule-item-inner">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="h6">Task report - uploaded weekly
                                                                        reports</div>
                                                                    <div class="list-group-dotted mt-3">
                                                                        <div class="list-group-wrap">
                                                                            <div class="p-3">
                                                                                <div class="media-group">
                                                                                    <div class="media rounded-0"><img
                                                                                            src="../images/icon/file-type-pdf.svg"
                                                                                            alt=""></div>
                                                                                    <div class="media-text ms-1"><a
                                                                                            href="#"
                                                                                            class="title">Modern Designs
                                                                                            Pattern</a><span
                                                                    ...
                                                                    <div class="alert alert-info mt-2" role="alert">
                                                                        <div class="d-flex"><em
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div>
                                                                                    <h6 class="alert-heading mb-0">Business
                                                                                        Template - UI/UX design</h6><span
                                                                                        class="smaller">Shared information
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="exampleModalLabel">Upload Document
                                                                            ...
                                                                            <div
                                                                                class="nk-block-head-content nk-block-head-tools">
                                                                                <ul>
                                                                                    <li>
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div class="js-upload"
                                                                                                            ...
                                                                                                            <div class="dz-message"
                                                                                                                data-dz-message>
                                                                                                                <div
                                                                                                                    class="dz-message-icon">
                                                                                                                </div> <span
                                                                                                                    class="dz-message-text">Drag
                                                                                                                    and drop
                                                                                                                    file</span>
                                                                                                                <div
                                                                                                                    class="dz-message-btn mt-2">
                                                                                                                    <button
                                        ...
                                        <div class="nk-block">
                                            <table class="datatable-init table">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="tb-col"><span class="overline-title">Document
                                                                Name</span></th>
                                                        <th class="tb-col"><span class="overline-title">Document
                                                                Type</span></th>
                                                        <th class="tb-col"><span class="overline-title">Upload Date</span>
                                                        </th>
                                                    ...
                                                    <tr>
                                                        <td class="tb-col">
                                                            <div class="media-group">
                                                                <div class="media-text"><a href="user-profile.html"
                                                                        class="title">rsz_20221120_150047.docx</a></div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td class="tb-col tb-col-xxl">
                                                            ...
                                                            <ul class="d-flex flex-wrap ">
                                                                ...
                                                                <li><button type="button" data-route="#"
                                                ...
                                                <div class="nk-block-head-between flex-wrap gap g-1">
                                                    ...
                                                    <div class="nk-head-content">
                                                        <ul class="d-flex gap-2">
                                                            <li><a href="#" class="btn btn-md d-md-none btn-primary"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#addUserModal"><span>Add</span></a>
                                                            </li>
                                                            <li><button class="btn btn-primary"><em
                                                                        class="icon ni ni-inbox-in-fill"></em>&nbsp;Export</button>
                                                            </li>
                                                            <li> <button class="btn btn-primary"
                                                                    data-bs-toggle="offcanvas"
                                                                    data-bs-target="#addOffcanvas"><em
                                                                        class="icon ni ni-filter-fill"></em> &nbsp;
                                                                    Filter</button></li>
                                                            <li> <button class="btn btn-primary"
                                                                    data-bs-toggle="offcanvas"
                                                                    data-bs-target="#project"><em
                                            ...
                                            <table class="table">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="tb-col"><span class="overline-title">Project
                                                                Name</span></th>
                                                        <th class="tb-col"><span class="overline-title">Project
                                                                Code</span></th>
                                                        <th class="tb-col"><span class="overline-title">Members</span>
                                                        </th>
                                                        <th class="tb-col"><span class="overline-title">Assigned
                                                                Date</span></th>
                                                        <th class="tb-col"><span class="overline-title">Deadline</span>
                                                        </th>
                                                        <th class="tb-col"><span class="overline-title">Process</span>
                                                        </th>
                                                        <th class="tb-col"><span class="overline-title">Action</span></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="tb-col">
                                                            <div class="media-group">
                                                                <div class="media-text"><a href="user-profile.html"
                                                                        class="title">Office management information
                                                                        system</a></div>
                                                            </div>
                                                        </td>
                                                                    ...
                                                                    <div class="dropdown-content py-1">
                                                                        <ul
                                                                            ...
                                                                            <li><a href="user-edit.html"><em
                                                                                        class="icon ni ni-edit"></em><span>Public
                                                                                        Gantt Chart</span></a>
                                                                            </li>
                                                                            <li><a href="user-edit.html"><em
                                                                                        class="icon ni ni-trash"></em><span>Public
                                                                                        Task Board</span></a>
                                                                            </li>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="nk-block-head-between flex-wrap gap g-2">
                                                            <div class="nk-block-head-content">
                                                                <h2 class="nk-block-title">
                                                                    <div class="form-control-wrap mb-3">
                                                                        <div
                                                                            class="form-control-icon start text-light md ps-0">
                                                            ...
                                                            <div class="nk-block-head-content">
                                                                <ul class="d-flex">
                                                                    ...
                                                                    <li> <button class="mb-3 btn btn-primary rounded-pill"
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#addTasksModal"><em
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <ul class="nav nav-tabs mb-3 nav-tabs-s1">
                                                                <li class="nav-item"> <button class="nav-link active"
                                                                        data-bs-toggle="tab"
                                                                        data-bs-target="#custom-mytask-tab-pane"
                                                                        type="button">My Task</button> </li>
                                                                <li class="nav-item"> <button class="nav-link"
                                                                        data-bs-toggle="tab"
                                                                        data-bs-target="#custom-completed-tab-pane"
                                                                        type="button">Completed</button> </li>
                                                                <li class="nav-item"> <button class="nav-link"
                                                                        data-bs-toggle="tab"
                                                                        data-bs-target="#custom-urgent-tab-pane"
                                                                        type="button">Urgent</button> </li>
                                                                <li class="nav-item"> <button class="nav-link"
                                                                        data-bs-toggle="tab"
                                                                        data-bs-target="#custom-deleted-tab-pane"
                                                                        type="button">Deleted</button> </li>
                                                                <li class="nav-item"> <button class="nav-link"
                                                                        data-bs-toggle="tab"
                                                                        data-bs-target="#custom-edited-tab-pane"
                                                                        type="button">Edited</button> </li>
                                                                <li class="nav-item"> <button class="nav-link"
                                                                        data-bs-toggle="tab"
                                                                        data-bs-target="#custom-marked-tab-pane"
                                                                        type="button">Marked</button> </li>
                                                            </ul>
                                                            <div class="tab-content" id="myTabContent">
                                                                <div class="tab-pane fade show active"
                                                                    id="custom-mytask-tab-pane">

                                                                    <!-- task lists -->
                                                                    <div class="nk-todo-item">
                                                                        <div class="nk-todo-item-elem nk-todo-item-check">
                                                                            <div class="form-check form-check-sm"><input
                                                                                    class="form-check-input todo-check-toggle"
                                                                                    type="checkbox" value=""
                                                                                    id="todo01"></div>
                                                                        </div>
                                                                        ...
                                                                        <div
                                                                            class="nk-todo-item-elem nk-todo-item-content">
                                                                            <div class="nk-todo-item-subject">Weekly
                                                                                Bigbazar Shopping
                                                                            </div>
                                                                        </div>
                                                                        <div class="nk-todo-item-elem nk-todo-item-action">
                                                                            <div
                                                                                ...
                                                                                <div class="gap-col"><a href="#"
                                                                                        class="btn btn-sm btn-icon btn-zoom"><em
                                                                                            class="icon ni ni-list-check"></em></a>
                                                                                </div>
                                                                                <div class="gap-col"><a href="#"
                                                                                        class="btn btn-sm btn-icon btn-zoom"><em
                                                        ...
                                                        <div class="nk-todo-head-pagination">
                                                            <ul class="nk-todo-head-nav">
                                                                <li class="nk-todo-toggle"><button
                                                                        class="btn btn-md btn-zoom btn-icon toggle-todo-aside"
                                                                        data-target="todoAside" data-parent=""><em
                            ...
                            <div class="modal fade" id="addTasksModal" tabindex="-1"
                                aria-labelledby="addTasksModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="addTasksModalLabel">Create Task</h4><button
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-lg-12">
                                                        <div class="form-group"><label class="form-label">Task
                                                            ...
                                                            <div class="form-control-wrap"><input type="text"
                                                                    class="form-control" placeholder="Task title"></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group"><label class="form-label">Assigned
                                                                To</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group"><label class="form-label">Due Date</label>
                                                            <div class="form-control-wrap"><input placeholder="dd/mm/yyyy"
                                                                    type="text" class="form-control js-datepicker"
                                                                    autocomplete="off" id="due-date"></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="d-flex gap g-2">
                                                            <div class="gap-col"><button class="btn btn-primary"
                                                                    type="submit">Add Task</button>
                                                            </div>
                                                            <div class="gap-col"><button type="button"
                                                                    class="btn border-0"
                                                        ...
                                                        <div class="nk-block-head-between flex-wrap gap g-1">
                                                            ...
                                                            <div class="nk-head-content">
                                                                <ul class="d-flex gap-2">
                                                                    ...
                                                                    <li> <button class="btn btn-primary"
                                                                            data-bs-toggle="offcanvas"
                                                                            data-bs-target="#reqleave"><em
                                                                                class="icon ni ni-plus"></em> &nbsp;
                                                                            Request Leave</button></li>
                                                                </ul>
                                                            </div>
                                                    ...
                                                    <table class="table">
                                                        <thead class="table-light">
                                                            <tr>
                                                                <th class="tb-col"><span
                                                                        class="overline-title">S.No</span></th>
                                                                <th class="tb-col"><span class="overline-title">Leave
                                                                        Requested By</span></th>
                                                                <th class="tb-col"><span class="overline-title">Leave
                                                                        Approved By</span></th>
                                                                <th class="tb-col"><span class="overline-title">Leave
                                                                        Start Date</span></th>
                                                                <th class="tb-col"><span class="overline-title">Leave End
                                                                        Date</span></th>
                                                                <th class="tb-col"><span
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="tb-col"><a href="user-profile.html"
                                                                        class="title">Raju Shrestha</a></td>
                                                                ...
                                                                <td class="tb-col">
                                                                    ...
                                                                    <span
                                                                        class="badge text-bg-success-soft">Approved</span>
                                    ...
                                    <div class="nk-content">
                                        ...
                                        <div class="nk-content-inner">
                                            <div class="nk-content-body">
                                                        ...
                                                        <div class="nk-block-head-content">
                                                            <ul class="d-flex">
                                                                <button class="btn btn-primary btn-add"
                                                                    data-bs-toggle="offcanvas"
                                                                    data-bs-target="#addOffcanvas"> <em
                                                                        class="icon ni ni-plus"></em>Add Timelog</button>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <table class="datatable-init table" data-nk-container="table-responsive">
                                                    <thead class="table-light">
                                                        <tr>
                                                            ...
                                                            <th class="tb-col"><span class="overline-title">Estimate
                                                                    Time</span></th>
                                                            <th class="tb-col"><span class="overline-title">Start
                                                                    Date</span></th>
                                                            <th class="tb-col"><span class="overline-title">End
                                                                    Date</span></th>

                                                            <th class="tb-col"><span class="overline-title">status</span>
                                                            </th>
                                                ...
                                                {{-- Add Modal --}}
                                                <div class="addoffcanvas offcanvas offcanvas-end offcanvas-size-xxlg"
                                                    id="addOffcanvas">
                                                    <div class="offcanvas-header border-bottom border-light">
                                                        <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Timelog
                                                            ...
                                                            <div class="card-body">
                                                                <form>
                                                                    <input type="hidden" name="_token"
                                                                        value="vwADvyetHVewekrMj3k7Bpg4D9XdaetgYlYpUR6U">
                                                                    <div class="row">
                                                                        <div class="col-lg-6"> <label for="projectName"
                                                                                class="form-label col-form-label"> Project
                                                                                Name </label>
                                                                        ...
                                                                        <div class="col-lg-6"> <label for="projectTask"
                                                                                class="form-label col-form-label"> Project
                                                                                Task </label>
                                                                            <div class="form-control-wrap">
                                                                                <input type="text" id="projectTask"
                                                                                    placeholder="" name="projectTask"
                                                                                    class="form-control " value="">
                                                                            </div>

                                                                        </div>
                                                                        <div class="col-lg-4"> <label
                                                                                for="projectEstimateTime"
                                                                                class="form-label col-form-label"> Project
                                                                                Estimate Time </label>
                                                                            <div class="form-control-wrap">
                                                                                <input type="time"
                                                                                    id="projectEstimateTime"
                                                                                    placeholder=""
                                                                                    name="projectEstimateTime"
                                                                                    class="form-control " value="">
                                                                            </div>
                                                                        ...
                                                                        <div class="col-lg-4"> <label
                                                                            ...
                                                                            <div class="form-control-wrap">
                                                                                <input type="date"
                                                                                    id="projectStartDate" placeholder=""
                                                                                    name="projectStartDate"
                                                                                    class="form-control " value="">
                                                                            </div>

                                                                        </div>
                                                                        <div class="col-lg-4"> <label for="projectEndDate"
                                                                                class="form-label col-form-label"> Project
                                                                                End Date </label>
                                                                            <div class="form-control-wrap">
                                                                                <input type="date" id="projectEndDate"
                                                                                    placeholder="" name="projectEndDate"
                                                                                    class="form-control " value="">
                                                                            </div>

                                                                        </div>
                                                                        <div class="col-lg-6"> <label for="alias"
                                                                                class="form-label col-form-label"> Alias
                                                                            </label>
                                                                            <div class="form-control-wrap">
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <label for="status"
                                                                                class="form-label col-form-label"> Status
                                                                            </label>
                                                                            <div class="form-control-wrap">
                                                                        ...
                                                                        <div class="col-lg-12"> <label for="remarks"
                                                                                class="form-label col-form-label"> Remarks
                                                                            </label>
                                                                            <div class="form-control-wrap">
                                                                        ...
                                                                        <div class="col-md-12"> <button
                                                                                class="mt-3 btn btn-primary  btn-primary"
                                                                                type="submit">
                                                                                Submit </button>
                                                                        </div>
                                                                </form>
                                        ...
                                        <div class="nk-content-body">
                                                ...
                                                <div class="nk-block-head-between flex-wrap gap g-2">
                                                    <div class="nk-block-head-content">
                                                        <ul class="d-flex">
                                                            <button class="btn btn-primary btn-add"
                                                                data-bs-toggle="offcanvas"
                                                                data-bs-target="#travelRequest"> <em
                                                                    class="icon ni ni-plus"></em>Add Travel
                                                                Request</button>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="nk-block">
                                                ...
                                                <table class="datatable-init table"
                                                    ...
                                                    <thead class="table-light">
                                                        <tr>
                                                            ...
                                                            <th class="tb-col"><span class="overline-title">traveller
                                                                    Name</span></th>
                                                            <th class="tb-col"><span
                                                                    class="overline-title">destination</span></th>
                                                            <th class="tb-col"><span class="overline-title">date</span>
                                                            </th>
                                                            <th class="tb-col"><span class="overline-title">time</span>
                                                            </th>

                                                            <th class="tb-col"><span
                                                                    class="overline-title">totalDays</span></th>
                                                ...
                                                <div class="addoffcanvas offcanvas offcanvas-end offcanvas-size-xxlg"
                                                    id="travelRequest">
                                                    <div class="offcanvas-header border-bottom border-light">
                                                        <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Travel
                                                            Request</h5><button type="button" class="btn-close"
                                                            data-bs-dismiss="offcanvas" aria-label="Close"></button>
                                                    </div>
                                                    ...
                                                    <div class="offcanvas-body" data-simplebar>
                                                        ...
                                                        <form>
                                                            <input type="hidden" name="_token"
                                                                value="rZd4xWwWDPDCfCIIXQYE1NjZrYBtUiWH4IOMpGG0">

                                                            <div class="row">

                                                                <div class="col-lg-6"> <label for="travellerName"
                                                                        class="form-label col-form-label"> Traveller Name
                                                                    </label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" id="travellerName"
                                                                            placeholder="" name="travellerName"
                                                                            class="form-control " value="">
                                                                    </div>

                                                                </div>

                                                                <div class="col-lg-6"> <label for="destination"
                                                                        class="form-label col-form-label"> Destination
                                                                    </label>
                                                                    <div class="form-control-wrap">
                                                                ...
                                                                <div class="col-lg-6"> <label for="date"
                                                                        class="form-label col-form-label"> Date </label>
                                                                    <div class="form-control-wrap">
                                                                ...
                                                                <div class="col-lg-6"> <label for="time"
                                                                        class="form-label col-form-label"> Time </label>
                                                                    <div class="form-control-wrap">
                                                                ...
                                                                <div class="col-lg-4"> <label for="totalDays"
                                                                        class="form-label col-form-label"> Total Days
                                                                    </label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" id="totalDays"
                                                                            placeholder="" name="totalDays"
                                                                            class="form-control " value="">
                                                                    </div>

                                                                </div>

                                                                <div class="col-lg-4"> <label for="alias"
                                                                        class="form-label col-form-label"> Alias </label>
                                                                    <div class="form-control-wrap">
                                                                        <input type="text" id="alias"
                                                                            placeholder="" name="alias"
                                                                            class="form-control " value="">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <label for="status"
                                                                        class="form-label col-form-label"> Status </label>
                                                                    <div class="form-control-wrap">
                                                ...
                                                <div class="nk-block-head-between flex-wrap gap g-2">
                                                    <div class="nk-block-head-content">
                                                        <ul class="d-flex">
                                                            <button class="btn btn-primary btn-add"
                                                                data-bs-toggle="offcanvas"
                                                                data-bs-target="#addAppreciation"> <em
                                                                    class="icon ni ni-plus"></em>Add Appreciation</button>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <table class="datatable-init table"
                                                    ...
                                                    <thead class="table-light">
                                                        <tr>
                                                            ...
                                                            <th class="tb-col"><span class="overline-title">Title</span>
                                                            </th>
                                                            <th class="tb-col"><span class="overline-title">Type</span>
                                                            </th>
                                                            <th class="tb-col"><span class="overline-title">Appreciated
                                                                    By</span></th>
                                                            <th class="tb-col"><span class="overline-title">Recieved
                                                                    By</span></th>
    ...
    <th class="tb-col"><span class="overline-title">Approved On</span></th> -->
                                                ...
                                                <div class="addoffcanvas offcanvas offcanvas-end offcanvas-size-xxlg"
                                                    ...
                                                    <div class="offcanvas-body" data-simplebar>
                                                        <form method="POST" action="#"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    {{ createText('appreciationTitle', 'Title', 'Appreciation Title') }}
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    {{ createText('appreciationType', 'appreciationType', 'Appreciation Type') }}
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    {{ createText('appreciatedBy', 'appreciatedBy', 'Appreciated By') }}
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    {{ createText('recievedBy', 'recievedBy', 'Recieved By') }}
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    {{ createDate('appreciationRecievedOn', 'appreciationRecievedOn', 'Recieved On', '', '', '') }}
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    {{ createDate('appreciatioanApprovedOn', 'appreciatioanApprovedOn', 'Approved On', '', '', '') }}
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    {{ createText('alias', 'alias', 'Alias') }}
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    {{ createLabel('status', 'form-label col-form-label', 'Status') }}{{ CreateSelect('status', 'status', '', 'Status', ['1' => 'Active', '0' => 'Inactive']) }}
                                                                </div>
                                                                <div class="col-12">
                                    ...
                                    <div class="nk-content-body">
                                            ...
                                            <div class="nk-block-head-between flex-wrap gap g-2">
                                                <div class="nk-block-head-content">
                                                    <ul class="d-flex">
                                                        <button class="btn btn-primary btn-add"
                                                            data-bs-toggle="offcanvas"
                                                            data-bs-target="#addShiftroaster"> <em
                                                                class="icon ni ni-plus"></em>Add Shift Roaster</button>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="nk-block">
                                            ...
                                            <table class="datatable-init table" data-nk-container="table-responsive">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="tb-col"><span class="overline-title">Roster Id</span>
                                                        </th>
                                                        <th class="tb-col"><span class="overline-title">From Date</span>
                                                        </th>
                                                        <th class="tb-col"><span class="overline-title">To Date</span>
                                                        </th>
                                                        <th class="tb-col"><span class="overline-title">shift</span>
                                                        </th>
                                                        <th class="tb-col"><span class="overline-title">alias</span>
                                                        </th>
                                                        <th class="tb-col"><span class="overline-title">status</span>
                                                        </th>
                                                        <th class="tb-col" data-sortable="false"><span
                                            ...
                                            <div class="addoffcanvas offcanvas offcanvas-end offcanvas-size-xxlg"
                                                id="addShiftroaster">
                                                <div class="offcanvas-header border-bottom border-light">
                                                    <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Shift Roaster
                                                    </h5><button type="button" class="btn-close"
                                                        data-bs-dismiss="offcanvas" aria-label="Close"></button>
                                                </div>
                                                <div class="offcanvas-body" data-simplebar>
                                                    <div class="card-body">
                                                        <form method="POST" action="#"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    {{ createText('rosterName_id', 'rosterName_id', 'Roster Id') }}
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    {{ createDate('shiftFromDate', 'shiftFromDate', 'From Date', '', '', '') }}
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    {{ createDate('shiftToDate', 'shiftToDate', 'To Date', '', '', '') }}
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    {{ createText('shift', 'shift', 'Shift') }}
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    {{ createText('alias', 'alias', 'Alias') }}
                                                                </div>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="form-control-wrap"> <select
                                                                        class="form-select" id="exampleFormSelect1"
                                                                        aria-label="Default select example">
                ...
                <div class="addoffcanvas offcanvas offcanvas-end offcanvas-size-xxl" id="addOffcanvas">
                    <div class="offcanvas-header border-bottom border-dark">
                        <h5 class="offcanvas-title" id="offcanvasTopLabel">Filters</h5><button type="button"
                                ...
                                <div class="row g-gs">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group"> <label class="form-label">Select Members</label>
                                            <div class="form-control-wrap">
                                                <select class="js-select" id="exampleFormSelectMultiple" multiple
                                                    aria-label="multiple select example" data-search="true">
