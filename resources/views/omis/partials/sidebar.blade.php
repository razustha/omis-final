        ...
        <div class="nk-sidebar-content">
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    ...
                    @if (Gate::check('hr-employee-index') ||
                            Gate::check('hr-department-index') ||
                            Gate::check('hr-designation-index') ||
                            Gate::check('hr-shiftroster-index') ||
                            Gate::check('hr-promotiondemotion-index') ||
                            Gate::check('hr-employeementtimeline-index') ||
                            Gate::check('hr-employeeonboarding-index') ||
                            Gate::check('hr-resignation-index') ||
                            Gate::check('hr-mangeholiday-index') ||
                            Gate::check('hr-appreciation-index') ||
                            Gate::check('hr-complaints-index') ||
                            Gate::check('hr-transfer-index') ||
...
@endcan -->
                    ...
                    @can('master-leavetype-index')
                        <li class="nk-menu-item has-sub"><a href="{{ route('master.leavetype.index') }}"
                                class="nk-menu-link"><span class="nk-menu-icon"><em
                                        class="icon ni ni-briefcase"></em></span><span class="nk-menu-text">Leave
                                    Type</span></a>
                        </li>
                    @endcan
                            ...
                            <ul class="nk-menu-sub">
                                ...
                                @can('crm-leads-index')
                                    <li class="nk-menu-item"><a href="{{ route('crm.leads.index') }}"
                                            class="nk-menu-link"><span class="nk-menu-text">Leads</span></a>
                                    </li>
                                @endcan
                            </ul>
                        </li>
                    ...
                    @if (Gate::check('hr-attendence-index') || Gate::check('hr-absentreason-index') || Gate::check('hr-latereasons-index'))
                        <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span
                    ...
                    @if (Gate::check('work-workprojects-index') || Gate::check('work-tasks-index') || Gate::check('work-timelog-index'))
                        <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span
                    ...
                    @endif
                    @if (Gate::check('finance-proposal-index') ||
                            Gate::check('finance-estimates-index') ||
                            Gate::check('finance-financepay-index') ||
                            Gate::check('finance-creditnotes-index') ||
                            Gate::check('finance-financeexpenses-index') ||
                            Gate::check('finance-advancerequest-index') ||
                            Gate::check('finance-cashrequest-index') ||
                            Gate::check('finance-expensesclaim-index') ||
                    ...
                    @endif
                    @if (Gate::check('notice-announcement-index') ||
                            Gate::check('notice-detailsview-index') ||
                    ...
                    @endif
                    @if (Gate::check('assets-assestcategory-index') ||
                            Gate::check('assets-equipmentdemand-index') ||
                    ...
                    @if (Gate::check('recruit-jobinterview-index') ||
                            Gate::check('recruit-jobpost-index') ||
                            Gate::check('recruit-jobapplication-index') ||
                            Gate::check('recruit-interviewschedule-index') ||
                            Gate::check('recruit-jobpost-index') ||
                            Gate::check('recruit-offerletter-index') ||
                            Gate::check('recruit-experienceletter-index') ||
                    ...
                    @endif
                    @if (Gate::check('requisition-travel-index') ||
                            Gate::check('requisition-requisitiontravel-index') ||
                    ...
                    @endif
                    @if (Gate::check('training-trainingtype-index') ||
                            Gate::check('training-traininglist-index') ||
                    ...
                    @endif
                    @if (Gate::check('travelfleet-driverroster-index') ||
                            Gate::check('travelfleet-maintenancelog-index') ||
                            Gate::check('travelfleet-fleetroster-index') ||
                            Gate::check('travelfleet-fleetmanagement-index') ||
                            Gate::check('travelfleet-travelslog-index') ||
                            Gate::check('travelfleet-vehiclelog-index') ||
                            Gate::check('travelfleet-travelrequest-index') ||
                            Gate::check('travelfleet-travelcategory-index') ||
                            Gate::check('travelfleet-travelapproval-index') ||
                            Gate::check('travelfleet-fleetrequest-index'))
                        <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span
                    ...
                    @endif
                    @if (Gate::check('officemanagement-generatorlogbook-index') ||
                            Gate::check('officemanagement-contract-index') ||
                            Gate::check('officemanagement-purchaseservice-index') ||
                            Gate::check('officemanagement-cashdeposite-index'))
                        <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span
...
@endcan
                    ...
                    @if (Gate::check('inventory-barcodemanagement-index') ||
                            Gate::check('inventory-product-index') ||
                            Gate::check('inventory-goodreceivedreconcile-index') ||
                            Gate::check('inventory-purchaseorder-index') ||
                            Gate::check('inventory-servicelog-index') ||
                            Gate::check('inventory-purchaseentry-index') ||
                            Gate::check('inventory-stockreconcile-index') ||
                            Gate::check('inventory-service-index'))
                        <li class="nk-menu-item has-sub"><a href="#" class="nk-menu-link nk-menu-toggle"><span
                    ...
                    @endif
                    @if (Gate::check('reports-taskreports-index') ||
                            Gate::check('reports-financereports-index') ||
                            Gate::check('reports-leavereports-index') ||
                            Gate::check('reports-expensesreports-index') ||
