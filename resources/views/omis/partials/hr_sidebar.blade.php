...
<li class="nk-menu-item"><a href="{{ route('work.timelog.index') }}"
        class="nk-menu-link"><span class="nk-menu-text">Time Logs</span></a></li>
</ul>
</li>
...
<li class="nk-menu-item"><a href="{{ route('notice.detailsview.index') }}"
        class="nk-menu-link"><span class="nk-menu-text">Details View</span></a></li>
...
<li class="nk-menu-item"><a href="{{ route('payroll.newpayment.index') }}"
        class="nk-menu-link"><span class="nk-menu-text">New Payment</span></a></li>
</ul>
</li>
...
<li class="nk-menu-item"><a href="{{ Route('recruit.jobinterview.index') }}"
        class="nk-menu-link"><span class="nk-menu-text">Job Interview</span></a></li>
<li class="nk-menu-item"><a href="{{ Route('recruit.jobpost.index') }}"
        class="nk-menu-link"><span class="nk-menu-text">Job Post</span></a></li>
...
<ul class="nk-menu-sub">
<li class="nk-menu-item"><a href="{{ route('reports.travelreports.index') }}"
        class="nk-menu-link"><span class="nk-menu-text">Task Report</span></a></li>

<li class="nk-menu-item"><a href="{{ route('reports.financereports.index') }}"
        class="nk-menu-link"><span class="nk-menu-text">Finance Report</span></a></li>
<li class="nk-menu-item"><a href="{{ route('reports.leavereports.index') }}"
        class="nk-menu-link"><span class="nk-menu-text">Leave Report</span></a></li>
<li class="nk-menu-item"><a href="{{ route('reports.expensesreports.index') }}"
        class="nk-menu-link"><span class="nk-menu-text">Expenses Report</span></a></li>
<li class="nk-menu-item"><a href="{{ route('reports.attendancereports.index') }}"
        class="nk-menu-link"><span class="nk-menu-text">Attendance Report</span></a></li>
