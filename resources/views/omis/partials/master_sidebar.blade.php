...
<li class="nk-menu-item"><a href="{{ route('master.organizationcategory.index') }}"
    class="nk-menu-link"><span class="nk-menu-text">Organization Category </span></a></li>
...
<li class="nk-menu-item"><a href="{{ route('master.employmentsizecategory.index') }}"
    class="nk-menu-link"><span class="nk-menu-text">Employment Size Category</span></a></li>
