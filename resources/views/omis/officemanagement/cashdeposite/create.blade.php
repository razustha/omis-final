@extends('omis.partials.layouts')
        ...
        <div class="nk-content">
            ...
            <div class="nk-block">
                        ...
                        <div class="card">
                            <div class="card-body">
                <form method="POST" action="{{route('officemanagement.cashdeposite.store')}}" enctype="multipart/form-data">
 @csrf 
...
</div><div class="col-lg-6">{{createText("declaredDate","declaredDate","DeclaredDate")}}
...
</div><div class="col-lg-6">{{createText("approvedDate","approvedDate","ApprovedDate")}}
