            ...
            <tr>
                ...
                <td class="tb-col">
                    <ul class="d-flex flex-wrap ">
                        <li><a href="{{ route('superadmin.package.show', [$item->package_id]) }}" type="button"
                                class="btn btn-color-success btn-hover-success btn-icon btn-soft"><em
                                    class="icon ni ni-eye"></em></a></li>
                        <li><a href="{{ route('superadmin.package.edit', [$item->package_id]) }}" type="button"
                        ...
                        <li><button type="button"
                                data-route="{{ route('superadmin.package.destroy', [$item->package_id]) }}"
