                        ...
                        <div class="nk-content-body">
                            <div class="nk-block-head">
                                <div class="nk-block-head-between flex-wrap gap g-2">
                                    ...
                                    <div class="nk-block-head-content">
                                        <ul class="d-flex">
                                            <button class="btn btn-primary btn-add" data-bs-toggle="offcanvas" data-bs-target="#addOffcanvas">  <em class="icon ni ni-plus"></em>Add Leaverequest</button>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<td class="tb-col">
                                                   ...
                                                   <li> <button class="btn btn-color-primary btn-hover-primary btn-icon btn-soft btn-addCity" data-route="{{route('requisition.leaverequest.edit',[$item->leaverequest_id])}}" data-bs-toggle="offcanvas" data-bs-target="#editoffcanvas">  <em
                           ...
                           <div class="addoffcanvas offcanvas offcanvas-end offcanvas-size-xxlg" id="addOffcanvas">
                            <div class="offcanvas-header border-bottom border-light">
                                <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Leaverequest</h5><button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                            </div>
...
<div class="row"><div class="col-lg-6">            <label for="leaveType" class="form-label col-form-label"> LeaveType </label>
            <div class="form-control-wrap">
                <input type="text" id="leaveType" placeholder="" name="leaveType" class="form-control " value="">
            </div>
...
</div><div class="col-lg-6">            <label for="departmentType" class="form-label col-form-label"> DepartmentType </label>
            <div class="form-control-wrap">
                <input type="text" id="departmentType" placeholder="" name="departmentType" class="form-control " value="">
            </div>
...
</div><div class="col-lg-6">            <label for="startDate" class="form-label col-form-label"> StartDate </label>
            <div class="form-control-wrap">
                <input type="text" id="startDate" placeholder="" name="startDate" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="endDate" class="form-label col-form-label"> EndDate </label>
            <div class="form-control-wrap">
                <input type="text" id="endDate" placeholder="" name="endDate" class="form-control " value="">
            </div>
        
</div><div class="col-lg-6">            <label for="totalDays" class="form-label col-form-label"> TotalDays </label>
            <div class="form-control-wrap">
                ...
                <input type="text" id="remarks" placeholder="" name="remarks" class="form-control " value="">
                    ...
                    Submit                </button>
                            ...
                            <div class="offcanvas offcanvas-end offcanvas-size-xxlg editoffcanvas" id="editoffcanvas">
                                <div class="offcanvas-header border-bottom border-light">
                                    <h5 class="offcanvas-title" id="offcanvasTopLabel">Add Leaverequest</h5><button type="button" class="btn-close"
