            ...
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    <div class="nk-block-head">
                        <div class="nk-block-head-between flex-wrap gap g-2">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title">Add Workfromhome</h1>

                            </div>
                            <div class="nk-block-head-content">
                                <ul class="d-flex">
                                    <li>
                                        <a href="{{ route('project.workfromhome.index') }}"
                    ...
                    <div class="nk-block">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="{{ route('project.workfromhome.store') }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-6">{{ createText('programName', 'programName', 'ProgramName') }}
                                        </div>
                                        <div class="col-lg-6">{{ createText('duration', 'duration', 'Duration') }}
                                        </div>
                                        <div class="col-lg-6">{{ createText('date', 'date', 'Date') }}
                                        </div>
                                        <div class="col-lg-6">{{ createText('time', 'time', 'Time') }}
                                        </div>
